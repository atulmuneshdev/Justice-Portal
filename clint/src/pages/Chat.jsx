...
const Chat = () => {
    ...
    return (
        <div className={`h-screen w-full flex overflow-hidden pt-20 ${dark ? 'bg-[#0b141a] text-white' : 'bg-[#f0f2f5] text-slate-900'}`}>
                            ...
                            <div className="flex-1 text-left min-w-0 ">
                                <div className="flex justify-between items-center">
                                    <h3 className="font-semibold text-black  truncate flex items-center gap-2">
                                        {person.name}
                                        <span className={`text-[9px] px-1.5 py-0.5 rounded-md uppercase font-bold tracking-tighter ${person.role === 'client' ? 'bg-blue-900 text-blue-600' : 'bg-emerald-100 text-emerald-600'}`}>
            ...
            {/* Chat Window */}
            <div className={`${!showMobileList ? 'flex' : 'hidden'} md:flex flex-1 flex-col relative bg-[#efeae2] dark:bg-[#0b141a] lg:h-[89vh] h-[79vh] w-full`}>
                {selectedChat ? (
                    <>
                        {/* Chat Header */}
                        <div className="px-4 py-2 border-b border-slate-900 flex items-center justify-between bg-[#f0f2f5] dark:bg-[#202c33] z-10">
